...
<<<<<<< HEAD
        print("action chosen")
=======
>>>>>>> eabd82759112566fbd77934b5758c926b2afd5dd
...
>>>>>>> eabd82759112566fbd77934b5758c926b2afd5dd
    ...
    def save(self, filename):
        ...
        joblib.dump((DDPG.displayName, mem), filename)

        mem1 = self.actor_model.get_weights()
        joblib.dump((DDPG.displayName, mem1), filename)
    ...
    def load(self, filename):
        ...
        if name != DDPG.displayName:
            ...
            # self.target_actor.set_weights(t_act)
    ...
    def memload(self, mem, mem1):
        self.actor_model.set_weights(mem)
        self.critic_model.set_weights(mem1)
